...
Use the guided actions for normal play. Server owners configuring production, passenger demand, financing, maintenance accounting, or yard plans should read the [Management advanced-options reference](../operations/management-advanced.md).
