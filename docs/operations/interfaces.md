...
The prepared industrial candidate places dossier creation and grouped delivery management in **Contracts**. Dispatch supplies wagon cargo/tag indicators and navigation. See the [industrial dossier workflow](industrial-dossiers.md) for refresh behavior and preloaded wagons.
