...
For the current worker projections, confirmed-mutation journal and save/autosave hooks, read [Unity work and persistent projections](../development/unity-persistence.md). Unity reads and physical effects remain on their owner thread.
